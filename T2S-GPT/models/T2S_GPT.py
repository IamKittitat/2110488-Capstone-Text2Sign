...
class T2S_GPT(nn.Module):
    ...
    def forward(self, Y, S_T, D_T_l, embed_dim = 1024):
        ...
        duration_transformer_logits = self.duration_transformer(H_code, D_T_l_input, tgt_mask=tgt_mask)
...
class T2SGPTLoss(nn.Module):
    ...
    def forward(self, code_transformer_logits, S_T_expected, D_T_l_pred, D_T_l_expected):
        ...
        return L_total, L_code, L_duration